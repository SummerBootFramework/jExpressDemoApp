...
@Scheduled(fixedRateMs = 1000)
public class MyCronJob implements Job {
    protected static final Logger log = LogManager.getLogger(MyCronJob.class.getName());

    @Override
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        String lastTransactionId = jobExecutionContext.getFireTime().toString();
        //log.info("fixedRateMs: " + jobExecutionContext + ", lastTransactionId: " + lastTransactionId);
    }
}
